...
def evalutate_code(original_file_path):
    ...
    if errors != 0:
        ...
        edited_folder_path = '/home/wyc/save_database_file/edited_code_saving/' + PATH_NAME
        ...
        if os.path.isdir(edited_folder_path): #judge the edited folder existed or not
            ...
            while edited_code_evaluated_num <= edited_code_num: #score the edited code one by one
                ...
                record_folder_path = '/home/wyc/save_database_file/score_recording/' + PATH_NAME
            ...
            record_folder_path = '/home/wyc/save_database_file/score_recording/' + PATH_NAME + '_failed'
            os.makedirs(record_folder_path, exist_ok=True)
